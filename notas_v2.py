...
st.set_page_config(page_title="NOTAS SSAA", page_icon="💪", layout="wide")
...
# ===================== BAREMOS COMPLETOS =====================
# (Los mismos que tú proporcionaste originalmente, completos)
baremos = {
    "PITO": {
        "Salto": {
    ...
    "PITA": {
        ...
        "Natación": {33: 10, 34: 9.8, 35: 9.6, 36: 9.4, 37: 9.2, 38: 9.0, 39: 8.8, 40: 8.6,
...
def calcular_notas(sexo, salto, flexiones, velocidad, mil, natacion, seis):
    ...
    notas = {
        ...
        "Natación": buscar_nota(natacion, tabla["Natación"], invertido=True),
...
with c1:
    ...
    flexiones = st.number_input("Flexiones válidas", min_value=0)

with c2:
    velocidad = st.number_input("Tiempo 50m (seg)", min_value=0.0, step=0.1)
    natacion = st.number_input("Natación 50m (seg)", min_value=0.0, step=0.1)
...
st.markdown(f"**Nota Final (×0.9):** 🟩 {nota_final:.2f}")
